...
class _ProfileBodyState extends State<ProfileBody> {
  ...
  List<Achievement> toAchievements(DocumentSnapshot<Map<String, dynamic>> snapshot) {
  ...
  String descWithInfo(String s,DocumentSnapshot<Map<String, dynamic>> snapshot,UserModel user) {
    final data = snapshot.data()!;
    ...
    return s.replaceAll("{views}", "$views")
            ...
            children: [
              AppBar(
                ...
                leading: Padding(
                  ...
                  child: ProfilePicture(name: user.name, radius: 14, fontsize: 12,img:user.photoUrl),
                ),
                elevation: 12,
                actions: [
                  IconButton(onPressed: _openSettings, icon: const Icon(FontAwesomeIcons.gear))
                ],
                toolbarHeight: 50,
              ),
              const SizedBox(height: 20),
              Center(child: ProfilePicture(name: user.name, radius: 64, fontsize: 36,img:user.photoUrl)),
              const SizedBox(height: 20),
                    ...
                    return Expanded(
                      child: GridView.builder(
                        ...
                        itemBuilder: (context,index) {
                          return buildAchievementCard(context,achievements[index]
  ...
  Widget buildAchievementCard(BuildContext context,Achievement achievement,String desc) {
    return Stack(
      children: [
        ClipRect(
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    Icon(achievement.icon,color: achievement.textColor,size: 16,),
                    const SizedBox(width: 10),
                    SizedBox(
                      width: 100,
                      child: Text(achievement.title,style: Theme.of(context)
